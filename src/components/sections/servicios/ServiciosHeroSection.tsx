  ...
  return (
    <section className="relative py-32 px-6 overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/images/servicios.jpeg')" }}
      />
      ...
      <div className="absolute inset-0 -z-10 bg-gradient-to-br from-[#1A261E]/70 via-[#0F1112]/70 to-[#111827]/70" />
          ...
          <FadeInUp delay={0.3}>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
              {[
                ...
                <div
                  key={idx}
                  className={`p-6 rounded-2xl bg-gradient-to-br ${service.color.replace(']', '/5]')} border border-white/10 hover:border-white/20 transition-all duration-300 hover:-translate-y-2 group`}
                >
